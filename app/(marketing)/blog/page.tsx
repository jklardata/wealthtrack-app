...
const ARTICLES: Article[] = [
  {
    ...
    excerpt:
      "Most freelancers underprice themselves by starting from the wrong number. Here's the exact formula—with a worked example targeting $150K/year—to calculate your minimum hourly rate and day rate.",
  ...
  {
    slug: "hsa-strategy-freelancers-2026",
    title: "HSA for Freelancers: The Triple Tax Advantage Most Self-Employed People Miss",
    excerpt: "The HSA is the only account with a deduction going in, tax-free growth in the middle, and tax-free withdrawals coming out. Here's how to stack it with your health insurance deduction for maximum tax savings.",
    category: "Taxes",
  ...
  {
    slug: "quarterly-estimated-taxes-freelancers-2026",
    title: "How to Pay Quarterly Estimated Taxes as a Freelancer (2026 Guide)",
    excerpt: "A complete guide to quarterly estimated taxes for freelancers: who owes, how to calculate using safe harbor vs. actual method, 2026 due dates, and tips to avoid the underpayment penalty.",
    category: "Taxes",
    categoryColor: "bg-purple-500",
    readTime: "10 min read",
    date: "February 2026",
  ...
  {
    slug: "budgeting-irregular-income-freelancers",
    title: "How to Budget When Your Income Is Unpredictable: A System for Freelancers",
    excerpt: "Traditional budgets break when income is variable. Here's the proven 3-account system that helps freelancers budget with irregular income and build lasting wealth.",
    category: "Budgeting",
  ...
  {
    slug: "solo-401k-vs-sep-ira-freelancers",
    title: "Solo 401(k) vs. SEP IRA: Which Retirement Account Is Right for Freelancers?",
    excerpt: "Compare the Solo 401(k) and SEP IRA side by side—contribution limits, eligibility, Roth options, and which account wins at different income levels for self-employed professionals in 2026.",
    category: "Retirement",
    categoryColor: "bg-emerald-500",
  ...
  },
  {
    ...
    excerpt: "You can deduct 100% of health insurance premiums as an above-the-line deduction on Schedule 1. Here's what qualifies, what doesn't, how Form 7206 works, and how ACA subsidies and S-Corp rules change the calculation.",
    category: "Taxes",
    categoryColor: "bg-purple-500",
    readTime: "8 min read",
    date: "February 2026",
